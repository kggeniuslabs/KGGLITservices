...
export function Footersap(){
    return(
        <>
            <div className="container-fluid bgcolor text-white " id="footersap">
                <div className="row">
                    <div className="col-lg-3 pt-5">
                        ...
                        <p><Sclink to="expertisesap" spy={true} smooth={true} duration={500} className="nav-link active text-white" aria-current="page">Services</Sclink></p>
                        <p> <Sclink to="sapform" spy={true} smooth={true} duration={500} className="nav-link text-white " href="#">Contact Us</Sclink></p>
                        {/* <ul>
                            <li>
                            ...
                            <li>
                            <Sclink to="expertisesap" spy={true} smooth={true} duration={500} className="nav-link active text-white" aria-current="page">Services</Sclink>
                            </li>
                            <li>
                            <Sclink to="sapform" spy={true} smooth={true} duration={500} className="nav-link text-white " href="#">Contact Us</Sclink>
                            </li>
                        </ul> */}
                    </div>
